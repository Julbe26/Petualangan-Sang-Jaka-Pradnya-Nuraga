...
define raja_marah = Character("Sri Maharaja ", color="#ffcc88")
define raja_netral = Character("Sri Maharaja ", color="#ffcc88")
define raja_panik = Character("Sri Maharaja ", color="#ffcc88")
define raja_senyum = Character("Sri Maharaja ", color="#ffcc88")
define raja_serius = Character("Sri Maharaja ", color="#ffcc88")
define raja_pointing = Character("Sri Maharaja ", color="#ffcc88")
...
define Kakek = Character('Ki Joyo Renggana', color="#9e1f0c")
...
image Kerajaan Hancur = "images/Kerajaan Hancur.png"
...
define Kakek = Character('Ki Joyo Renggana', color="#FF6347")
define Pedagang = Character('Pedagang', color="#FFD700")
...
label start:
    ...
    ajudan "Yang Mulia, gawat, hamba telah mendengar bahwa kerajaan Prabu Wijayapranata sebentar lagi akan menyerang."
...
label school_intro:
    ...
    "Guru masuk ke kelas dan memulai pembelajaran tentang Kerajaan Mandalapura dan Suryanagari."
    show teacher at Position(xalign=0.5,yalign=-0.8)
    g'Hari ini kita akan belajar tentang Kerajaan  dan Prabu Wijayapranata. Dua kerajaan yang bertempur tanpa perang fisik.'
    ...
    # Transition ke Kerajaan Mandalapura
    ...
    ajudan"'Kerajaan Suryanagari akan menyerang! Persiapkan dirimu!'"
    hide ajudan_salute
    show a_worried at Position(xalign=0.0, yalign=-1.0, yoffset=-50)
    "Anthony merasa bingung, apakah ia telah terlempar ke masa lalu?"
    a"(dalam hati) 'Kerajaan Mandalapura? Nama itu terdengar familiar... Apa aku ada di masa lalu?'"
    hide a_worried
    stop music fadeout 1.75
...
label waw:
    ...
    "Anthony mulai mencari bantuan dari seorang kakek tua yang berjualan di pasar."
    ...
    a "Bagaimana jika aku berusaha menyelidiki bagaimana caranya mengalahkan Kerajaan Suryanagari, mungkin dengan berbaur dengan rakyat sekitar?"
...
label start_adventure:
    ...
    "Lokasi pertama yang Anthony teliti adalah Pasar Tradisional, sesuai dengan saran Kakek, Kakek berkata bahwa pedagang di Pasar Tradisional adalah penyimpan dan penyampai pesan terbaik di seluruh kerajaan."
    stop music fadeout 1.75
    # First choice of action
    menu:
        "Anthony bertanya kepada Pedagang":
            jump ask_merchants
        "Anthony bertanya pada seorang asing":
...
label suspicious_activity:
    ...
    "Raja kerajaan Suryanagari memang cerdas, peperangan tidak selalu harus bersifat fisik, tetapi memang penjajahan ekonomi seperti ini jauh lebih efektif!"
...
label frame_xx:
    ...
    narrator "Karena perilaku Anthony yang konsumtif, ia melupakan misi sebenarnya dari penyelidikan dan kembali ke pasar untuk membeli barang-barang lain."
...
label listen_to_Kakek:
    ...
    narrator "Anthony menyadari bahwa para pedagang bukan berasal dari Kerajaan Mandalapura, berdasarkan penampilan yang mencurigakan, bahasa asing yang mereka gunakan, dan sikap gugup mereka."

    a "Waduh, dengan semua perbedaan tersebut, pedagang-pedagang ini tidak mungkin berasal dari Kerajaan Mandalapura! Aku harus mengambil tindakan segera!"
...
label inform_raja:
    ...
    narrator "Anthony akhirnya mendatangi istana dan memohon untuk menemui Raja."

    raja "Ada apa seorang anak kecil ingin menemuiku?"

    a "Paduka Raja, maaf atas kelancanganku ini, tetapi aku menemukan banyak pedagang asing di wilayah kita. Sepertinya mereka berasal dari Kerajaan Suryanagari, Paduka!"
    ...
    narrator "Sikap konsumtif warga menyebabkan Kerajaan Mandalapura hancur."

    jump grand_ending_failure


label grand_ending_failure:
    scene Kerajaan Hancur with fade

    narrator "Kerajaan Mandalapura kini tinggal reruntuhan, akibat sikap konsumtif rakyatnya. Anthony tersadar bahwa ia kembali ke kelasnya."
...
label classroom_reality:
    ...
    show a_worried at Position(xalign=0.5,yalign=-0.8)
    a "Bu Guru, Bu Guru, bagaimana nasib Kerajaan Mandalapura? Apakah mereka menang atau kalah melawan Kerajaan Suryanagari?"
    show teacher at Position(xalign=0.0,yalign=-0.8, yoffset=-50)
    g "Haduh, Nak, kamu ini tidak mendengarkan. Kerajaan Mandalapura kalah akibat konflik internal yang dipicu oleh informasi yang salah."
...
label inform_citizen:
    ...
    narrator "Kabar tersebut tersebar luas dengan cepat, hingga Raja Sri Maharaja sendiri mendengarnya."
...
label investigate_market:
    ...
    citizen_b_neutral "Ampuni kami, Yang Mulia! Kami hanya diperintahkan oleh Raja Prabu Wijayapranata untuk berdagang di sini."

    raja "Kurang ajar! Pengawal, gusur mereka sekarang juga! Aku tidak akan membiarkan Kerajaan Suryanagari mencuri tanah ini!"
...
label classroom_final:
    ...
    a "Bu Guru, Bu Guru, bagaimana nasib Kerajaan Mandalapura? Apakah mereka menang atau kalah melawan Kerajaan Suryanagari?"
    show teacher at Position(xalign=0.5,yalign=-0.8)
    g "Haduh, Nak, kamu ini tidak mendengarkan. Kerajaan Mandalapura menang berkat seorang pemuda bernama Jaka Pradnya Nuraga, yang dengan cerdik membantu kerajaan."

    a "Untunglah... Segala usaha dan pengorbanan tidak sia-sia. Aku akan belajar dari kesalahan Kerajaan Mandalapura dan berhenti bersikap konsumtif."
