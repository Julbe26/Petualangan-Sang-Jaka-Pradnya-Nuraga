...
# In gui.rpy or script.rpy, define the button style:
style menu_button:
    background "namebox.png"  # Replace with your square button image
    padding (10, 20)  # Adjust the padding for the text inside
    align (0.5, 0.5)  # Center align text
    xminimum 200  # Minimum width for buttons
    xmaximum 200  # Maximum width for uniformity
    yminimum 50   # Minimum height for buttons
    ymaximum 50
    font "your_font.ttf"  # Replace with your preferred font
    color "#FFFFFF"  # Text color
    hover_background "button_hover.png"  # Add hover effect if available

style menu_button:
    background Frame("namebox.png", 10, 10)  # Use a frame for resizable borders
    hover_background Frame("namebox.png", 10, 10)